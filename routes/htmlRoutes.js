...
module.exports = function (app) {
    ...
    app.get("/bands/a-z", function (req, res) {
        db.Bands.findAll({
            where: { bandName: { [Sequelize.Op.regexp]: ["^[a-e]"] } },
            order: [
                ["bandName", "ASC"]
            ]
        })
            .then(function (allaebands) {
                ...
                db.Bands.findAll({
                    where: { bandName: { [Sequelize.Op.regexp]: ["^[f-j]"] } },
                    order: [
                        ["bandName", "ASC"]
                    ]
                })
                    .then(function (allfjbands) {
                        ...
                        db.Bands.findAll({
                            where: { bandName: { [Sequelize.Op.regexp]: ["^[k-o]"] } },
                            order: [
                                ["bandName", "ASC"]
                            ]
                        })
                            .then(function (allkobands) {
                                ...
                                db.Bands.findAll({
                                    where: { bandName: { [Sequelize.Op.regexp]: ["^[p-t]"] } },
                                    order: [
                                        ["bandName", "ASC"]
                                    ]
                                })
                                    .then(function (allptbands) {
                                        ...
                                        db.Bands.findAll({
                                            where: { bandName: { [Sequelize.Op.regexp]: ["^[u-z]"] } },
                                            order: [
                                                ["bandName", "ASC"]
                                            ]
                                        })
                                            .then(function (alluzbands) {
                                                ...
                                                db.Bands.findAll({
                                                    where: { bandName: { [Sequelize.Op.regexp]: ["^[0-9!@#$%^&*()_+\-=\[\]{};:\\|,.<>\/?]*$]"] } },
                                                    order: [
                                                        ["bandName", "ASC"]
                                                    ]
                                                })
